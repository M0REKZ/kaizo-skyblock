...
dofile(modpath..'/skyblock.levels.6.lua')
dofile(modpath..'/skyblock.levels.7.lua')
dofile(modpath..'/skyblock.levels.8.lua')
dofile(modpath..'/skyblock.levels.9.lua')
dofile(modpath..'/skyblock.levels.10.lua')
